...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<RespuestaApi<Map<String, String>>>> handleValidation(WebExchangeBindException ex) {
        ...
        return Mono.just(
                ResponseEntity.badRequest()
                        .contentType(MediaType.APPLICATION_JSON)
                        .body(RespuestaApi.error("Error de validación", errores))
        );
    }

    @ExceptionHandler(WebClientResponseException.class)
    public Mono<ResponseEntity<RespuestaApi<String>>> handleWebClient(WebClientResponseException ex) {
        ...
        return Mono.just(
                ResponseEntity.status(statusCode)
                        .contentType(MediaType.APPLICATION_JSON)
                        .body(RespuestaApi.error(mensaje, ex.getResponseBodyAsString()))
        );
    }
